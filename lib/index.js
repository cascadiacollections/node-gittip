...
/**
 * Class for handling communications with gratipay's API.
 *
 * @param {Object} options The Client's options object.
 */
function gratipay (options) {
    if (!(this instanceof gratipay)) {
        return new gratipay(options);
    }
 ...
 */
gratipay.prototype.get = function (url, params, callback) {
...
/**
 * Function for requesting and returning gratipay's pay days data in JSON form.
 *
 * @param {Function}    callback    Callback function that will be called when the processing is done.
 */
gratipay.prototype.getPaydays = function (callback) {
...
/**
 * Function for requesting and returning gratipay's statistical data in JSON form.
 *
 * @param {Function}    callback    Callback function that will be called when the processing is done.
 */
gratipay.prototype.getStats = function (callback) {
...
/**
 * Function for requesting and returning a gratipay User's public data in JSON form.
 *
 * @param {Object}      options     Options object that contains the user's name to lookup and optional API key.
 * @param {Function}    callback    Callback function that will be called when the processing is done.
 */
gratipay.prototype.getUser = function (options, callback) {
	/*
	if (options.key) {
		this.options.key = options.key
	} 
	else if (!this.options.key) {
		throw new Error('No gratipay API key supplied.');
	}
	*/
...
/**
 * Function for requesting and returning a gratipay User's private tip data in JSON form.
 ...
 * @param {Function}    callback   Callback function that will be called when the processing is done.
 */
gratipay.prototype.getTips = function (options, callback) {
	/*
	// Check that options exists
    var options = {
...
/**
 * Function for creating / updating a gratipay User's tip(s) to gratipay.
 ...
 * @param {Function}    callback   Callback function that will be called when the processing is done.
 */
gratipay.prototype.postTips = function (options, callback) {

}

module.exports = gratipay;